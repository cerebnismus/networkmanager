/*
 ******************************************
 * TCP/IP packet capture using libpcap.
 * Usage: raw_capture [packet_count]
 * Example: ./raw_capture 8
 ******************************************
 * Example compiler command-line for GCC:
 *  gcc raw_capture.c -o raw_capture -lpcap
 ******************************************
 */
